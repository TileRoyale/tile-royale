...
const AVATARS = {
  ...
  // Bundle unlocks
  bundle: [
    { id:'av_fire_lord',icon:'🌋', name:'Fire Lord',  border:'#ff6600', bg:'#1a0300',  unlock:'bundle_fire',      unlockDesc:'Fire Pack' },
    { id:'av_champion', icon:'⚔️', name:'Champion',   border:'#ffd700', bg:'#1a1400',  unlock:'bundle_champion',  unlockDesc:'Champion Bundle' },
    { id:'av_legend2',  icon:'🌠', name:'Aurora',     border:'#00aaff', bg:'#001020',  unlock:'bundle_legend',    unlockDesc:'Legend Bundle' },
  ],
  // Whale exclusive
  whale: [
    { id:'av_whale',    icon:'🐋', name:'Whale',       border:'#00e5ff', bg:'#001525',  unlock:'bundle_whale_1', unlockDesc:'Whale Pack',       whaleBorder:true },
    { id:'av_ocean',    icon:'🌊', name:'Deep Ocean',  border:'#00e5ff', bg:'#000d1a',  unlock:'bundle_whale_2', unlockDesc:'Deep Ocean Bundle',whaleBorder:true },
    { id:'av_obsidian', icon:'🖤', name:'Obsidian',    border:'#00e5ff', bg:'#050005',  unlock:'bundle_whale_2', unlockDesc:'Deep Ocean Bundle',whaleBorder:true },
  ],
};
